          ...
          <>
            ...
            <div className="onboarding-points">
              ...
              <div className="onboarding-point">
                ...
                <div>
                  <div className="onboarding-point-title">Tor relay support</div>
                  <div className="onboarding-point-desc">Traffic to .onion relays is routed through Tor automatically.</div>
                </div>
              </div>
              <div className="onboarding-point">
